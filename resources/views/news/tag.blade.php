...
@section('title', '#' . $tag->name . ' - Notícias - Atrocidades')
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <header class="mb-8">
            ...
            <h1 class="text-white text-2xl md:text-3xl font-bold flex items-center gap-2">
                <span class="text-red-500">#</span>{{ $tag->name }}
            </h1>
            <p class="text-gray-500 mt-2">
                {{ $news->total() }} {{ $news->total() === 1 ? 'notícia' : 'notícias' }} com esta tag
            </p>
        </header>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="col-span-full text-center py-16">
                <p class="text-gray-500">Nenhuma notícia com esta tag.</p>
            </div>
            @endforelse
        </div>
