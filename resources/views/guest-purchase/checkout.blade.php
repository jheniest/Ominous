        ...
        <div class="py-12">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="mb-8">
                    ...
                    <p class="mt-1 text-neutral-400">Preencha seus dados e escolha o método de pagamento</p>
                </div>
                    ...
                    <div class="lg:col-span-2">
                        <form method="POST" action="{{ route('guest.purchase.store') }}" id="payment-form">
                            ...
                            <div class="bg-neutral-950/60 backdrop-blur-lg border border-neutral-800 rounded-lg p-6 mb-6">
                                <h3 class="text-lg font-semibold text-neutral-200 mb-4">Seus Dados</h3>
                                
                                <div class="space-y-4">
                                    <div>
                                        <label for="name" class="block text-sm font-medium text-neutral-400 mb-2">Nome Completo *</label>
                                        <input type="text" id="name" name="name" required value="{{ old('name') }}" class="w-full px-4 py-3 bg-neutral-900 border border-neutral-800 rounded-lg text-neutral-200 placeholder-neutral-600 focus:outline-none focus:ring-2 focus:ring-red-900/50 focus:border-transparent">
                                        @error('name')
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="email" name="email" required value="{{ old('email') }}" class="w-full px-4 py-3 bg-neutral-900 border border-neutral-800 rounded-lg text-neutral-200 placeholder-neutral-600 focus:outline-none focus:ring-2 focus:ring-red-900/50 focus:border-transparent">
                                        <p class="text-xs text-neutral-500 mt-1">Os convites serão enviados para este email</p>
                                        @error('email')
                                            <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                                        @enderror
                                    </div>
                            ...
                            <!-- Payment Methods (same as authenticated checkout) -->
                            <div class="space-y-4">
                            ...
                            <div class="mt-8 flex gap-4">
                                <a href="{{ route('guest.purchase.index') }}" class="flex-1 px-6 py-3 bg-neutral-900 border border-neutral-800 text-neutral-400 rounded-lg hover:border-neutral-700 transition font-medium text-center">
                                    Voltar
                                </a>
