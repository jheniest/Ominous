<x-guest-layout>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('guest.purchase.confirm', $purchase->id) }}" class="mb-6">
                @csrf
            ...
            <div class="text-center">
                <a href="{{ route('guest.purchase.index') }}" class="text-neutral-400 hover:text-neutral-200 transition text-sm">
