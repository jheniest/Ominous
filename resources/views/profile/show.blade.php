...
@section('title', '@' . $user->nickname . ' - ' . config('app.name'))
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-gray-900 rounded-lg border-2 border-red-900/50 shadow-2xl shadow-red-900/30 p-8 mb-8">
            <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                ...
                <div class="flex-1 text-center sm:text-left">
                    ...
                    <!-- Nickname with @ -->
                    <p class="text-red-400 font-mono text-lg mb-3">{{ '@' . $user->nickname }}</p>
                    ...
                    <div class="flex items-center justify-center sm:justify-start gap-6 text-sm">
                        <div>
                            <span class="text-gray-500">Publicações:</span>
        ...
        <div>
            ...
            <div class="text-center py-16 bg-gray-900 rounded-lg border border-red-900/30">
                ...
                <p class="text-xl text-gray-400">Nenhuma publicação ainda</p>
            </div>
            @endif
        </div>
    </div>
