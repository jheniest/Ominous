    ...
    <div class="min-h-screen bg-black text-gray-100 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center mb-8">
                <h1 class="text-3xl font-bold text-red-500">My Videos</h1>
                <a href="{{ route('videos.create') }}" class="px-6 py-3 bg-red-600 hover:bg-red-700 text-white rounded-lg font-semibold transition-colors shadow-lg shadow-red-900/50">
                    Upload Video
                </a>
            </div>
                ...
                <div class="bg-gray-900 rounded-lg overflow-hidden border border-red-900/30 shadow-lg">
                    ...
                    <div class="p-4">
                        ...
                        <div class="mt-2 p-2 bg-red-900/20 border border-red-700 rounded text-xs text-red-300">
                            <strong>Reason:</strong> {{ $video->rejection_reason }}
                        </div>
                        @endif
                        ...
                        <div class="flex gap-2 mt-4">
                            <a href="{{ route('videos.edit', $video) }}" class="flex-1 px-4 py-2 bg-gray-700 hover:bg-gray-600 text-white text-sm font-semibold rounded-lg text-center transition-colors">
                                Editar
                            </a>
                            <form method="POST" action="{{ route('videos.destroy', $video) }}" onsubmit="return confirm('Tem certeza que deseja deletar este vídeo? Esta ação não pode ser desfeita.')" class="flex-1">
                                @csrf
                                @method('DELETE')
            ...
            <div class="text-center py-16 bg-gray-900 rounded-lg border border-red-900/30">
                ...
                <p class="text-xl text-gray-400 mb-4">You haven't uploaded any videos yet</p>
                <a href="{{ route('videos.create') }}" class="inline-block px-6 py-3 bg-red-600 hover:bg-red-700 text-white rounded-lg font-semibold transition-colors">
